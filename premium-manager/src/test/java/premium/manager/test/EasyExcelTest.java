...
public class EasyExcelTest {
    ...
    public static void read() {
        // 获取文件位置
        String fileName = "E://JavaProj//Projects//PremiumSelection//01.xlsx";
        // 调用方法
    ...
    public static void write() {
        ...
        EasyExcel.write("E://JavaProj//Projects//PremiumSelection//02.xlsx", CategoryExcelVo.class)
